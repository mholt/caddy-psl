module github.com/mholt/caddy-psl

go 1.20

require (
	github.com/caddyserver/caddy/v2 v2.7.0-beta.1
...
require (
	...
	github.com/caddyserver/certmagic v0.17.3-0.20230511183644-8728b186fa68 // indirect
